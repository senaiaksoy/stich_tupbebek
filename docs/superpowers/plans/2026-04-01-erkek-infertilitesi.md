...
```html
        ...
        <section class="max-w-3xl mx-auto px-8 mb-16">
            <div class="bg-surface-container-low p-8 rounded-2xl border-l-4 border-primary flex flex-col md:flex-row items-center gap-8">
                ...
                <div>
                    <p class="font-headline text-lg text-on-surface mb-1">Yayın Kurulu</p>
                    <p class="text-sm text-on-surface-variant">
                        Bu sayfa, üreme sağlığı alanında uzman <strong class="text-primary">Yayın Kurulu</strong> tarafından tıbbi açıdan incelenmiş ve onaylanmıştır. İçerik, güncel kılavuzlar ve kanıta dayalı tıp ilkeleri doğrultusunda hazırlanmıştır.
                    </p>
                </div>
            </div>
        </section>
